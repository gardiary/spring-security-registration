...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final List<Privilege> adminPrivileges = new ArrayList<>(Arrays.asList(readPrivilege, writePrivilege, passwordPrivilege, managerPrivilege));
        ...
        createUserIfNotFound("manager@test.com", "Manager", "Test", "manager", new ArrayList<>(Arrays.asList(managerRole)));
